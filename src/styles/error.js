...
export default `${homeCSS}${schemaIssuesCSS}
  .error-layout { width: 100%; }
  .error-content { width: min(720px, 100%); margin: 0 auto; }
  .error-code { display: inline-flex; align-items: center; min-height: 24px; margin-bottom: 14px; padding: 3px 8px; border: 1px solid #fecaca; border-radius: var(--radius-pill); background: #fef2f2; color: #b91c1c; font-size: 10px; font-weight: 800; letter-spacing: 0.05em; }
